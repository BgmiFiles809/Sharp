...
TELEGRAM_BOT_TOKEN = '8051776188:AAEfH7tgGO5cM1v_jiY4jdWwgdJHtOGBavY'
...
async def sharp(update: Update, context: CallbackContext):
    ...
    if len(args) != 2:
        await context.bot.send_message(chat_id=chat_id, text="*⚠️ Usage: /vip <add|rem> <user_id>*", parse_mode='Markdown')
        return
...
def main():
    ...
    application.add_handler(CommandHandler("vip", sharp))
